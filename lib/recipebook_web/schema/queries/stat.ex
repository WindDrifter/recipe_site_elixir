defmodule RecipebookWeb.Schema.Queries.Stat do
  ...
  object :stat_queries do
    ...
    @desc "For checking stats. Order in desending order by default. There are 2 types of stats
    Recipe name and recipe categories. If is_category is true then it will show only category stats.
    Otherwise it will show recipe name stats. Top is for limit the amount. IE top 3 will show the first 3 stat that have
    Highest view count
    "
